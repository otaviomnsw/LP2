...
class Aplicacao:
    def __init__(self):
        ...
        btn_sair = Gtk.Button(label = "Sair", use_underline = True)
        btn_sair.connect("clicked", self.sair)

        
        box_vert.pack_start(box_hor, False, False, 0)
        box_vert.pack_start(self.lbl_msg, False, False, 0)
        box_vert.pack_end(btn_sair, False, False, 0)
